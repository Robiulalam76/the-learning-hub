    ...
    return (
        <div>
            <div class=" bg-gray-20 flex flex-wrap items-center justify-center">
                <div class="w-[95%] md:w-[600px] bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out mt-12">
                    ...
                    <div class="relative">
                        ...
                        <div class="px-7 mb-8">
                            {
                                user?.displayName ? <h2 class="text-3xl font-bold text-green-800 dark:text-gray-300">{user?.displayName}</h2>
                                    :
                                    <h2 class="text-3xl font-bold text-green-800 dark:text-gray-300">No set name</h2>
                            }
                    ...
                    <div className='flex justify-center'>
                        {
                            user?.uid && <button className='bg-blue-600 hover:bg-rose-600 text-white font-bold py-2 px-8 border-0 rounded-lg mb-3' onClick={handleLogOut}>Logout</button>
                        }
                    </div>
                </div>
            </div>
