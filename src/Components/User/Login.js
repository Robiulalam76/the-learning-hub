...
const Login = () => {
    ...
    return (
        <div className='flex justify-center my-12'>
            ...
            <div className="flex flex-col w-[90%] md:w-[85%] max-w-md px-4 py-8 bg-white rounded-lg shadow-lg bg-gradient-to-r from-indigo-200 to-rose-300 sm:px-6 md:px-8 lg:px-10">
