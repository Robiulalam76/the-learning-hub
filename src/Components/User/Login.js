...
const Login = () => {
    return (
        <div className='flex justify-center my-12'>
            ...
            <div className="flex flex-col w-[85%] w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-blue-600 sm:px-6 md:px-8 lg:px-10">
                <div className="self-center font-bold mb-6 text-2xl text-gray-600 sm:text-2xl dark:text-white">
