...
const Home = () => {
    return (
        <div>
            ...
            <main className="bg-gradient-to-r from-indigo-800 via-purple-600 to-blue-300 h-screen">
                    ...
                    <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between my-16">
                        <div className="sm:w-2/3 lg:w-2/5 flex flex-col z-20">
                            ...
                            <div className="flex mt-8">
                                <Link className="uppercase py-2 px-4 rounded-lg bg-pink-500 border-2 text-white text-md mr-4 hover:bg-pink-400">
                                    Get started
                                </Link>
